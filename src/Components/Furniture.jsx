...
function Furniture() {
  ...
  return (
    <div ref={sectionRef}>
      <div className='furniture border-t-2 border-[#c72a01] h-auto min-h-screen md:h-screen w-full flex flex-col md:flex-row justify-center overflow-hidden items-center md:overflow-visible'>
        ...
        <div className="content w-full md:w-1/2 flex flex-col gap-8 md:gap-10 lg:gap-16 items-start md:items-end justify-start order-1 md:order-none" style={{padding: '40px'}}>
        <div className="text-4xl md:text-6xl lg:text-8xl text-[#C72A01] font-['restore'] leading-tight break-words">
          Furniture That Fits Your Life
        </div>
        <div 
          className="text-base md:text-2xl lg:text-3xl w-full font-['slabo'] tracking-tight font-semibold break-words"
          style={{color: '#666', paddingRight: '0px'}}
        >
